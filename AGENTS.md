...
## Data Files
`data/*.json` is gitignored (too large, third-party, game-patch-dependent).
Fetch from the RePoE community export (GitHub: brather1ng/RePoE). You need:
- `data/mods.json` — all craftable mods with spawn weights
- `data/base_items.json` — base item definitions and tags
